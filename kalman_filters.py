...
#and reduced after a motion step.

#this algorithm has been used by google's self driving car for tracking other vehicles in its vicinity, predicitng their 
#velocity. It is very beneficial when sensor measurements have been noisy.

#the following code is helpful for a 4-d world, where we make best estimates for x position, y position, and the respective
#x and y velocities.
